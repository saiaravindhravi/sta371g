...
\begin{align*}
  ...
  &= \Sexpr{ (0.993)*(0.004) / ((0.993)*(0.004) + (0.002)*(0.996)) }
\end{align*}
\end{frame}
...
\begin{frame}{Another way to look at it}
  ...
  Of the $3972+1992=5964$ people that tested positive, only $3972$ (\Sexpr{100*3972/(3972+1992)}\%) are actually HIV positive!
  \lc
\end{frame}
...
\begin{frame}{Example 2: Supplier detective work}
  \begin{align*}
    ...
    &= \Sexpr{(0.005*0.55)/(0.005*0.55 + 0.003*0.45)}
  \end{align*}
  \bigskip\pause
